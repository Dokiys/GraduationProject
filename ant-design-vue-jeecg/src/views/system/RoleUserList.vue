          ...
          <span slot="action" slot-scope="text, record">
            ...
            <a-dropdown>
              ...
              <a-menu slot="overlay">
                ...
                <a-menu-item v-if="record.id != '1253856817919787009' 
                                && record.id != '1253856742812385281'
                                && record.id != '1253856709492834305'
                                && record.id != '1253145652369498113'
                                && record.id != 'f6817f48af4fb3af11b9e8bf182f618b'">
    ...
    <a-col :md="rightColMd" :sm="24" v-if="this.rightcolval == 1">
      <a-card :bordered="false">
        ...
        <div class="table-operator" :md="24" :sm="24" style="margin: -25px 0px 10px 2px">
          ...
          <a-button @click="handleAddUserRole" type="primary" icon="plus" style="margin-top: 16px">添加用户</a-button>
