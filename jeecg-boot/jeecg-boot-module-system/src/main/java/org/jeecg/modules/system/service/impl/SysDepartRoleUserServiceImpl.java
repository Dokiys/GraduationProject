...
public class SysDepartRoleUserServiceImpl extends ServiceImpl<SysDepartRoleUserMapper, SysDepartRoleUser> implements ISysDepartRoleUserService {
    ...
    @Override
    public List<SysDepartRoleUser> listByUserIds(List<String> userIds) {
        return sysDepartRoleUserMapper.listByUserIds(userIds);
    }

    @Override
    public List<String> getByUserId(String userId) {
        return sysDepartRoleUserMapper.getByUserId(userId);
    }
